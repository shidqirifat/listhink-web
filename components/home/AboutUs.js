...
export default function AboutUs() {
  ...
  return (
    <div className="max-w-7xl px-8 lg:px-3 -mt-12 md:-mt-12 mx-auto">
      <div id="about-us" className="pt-24 md:pt-28 relative">
        ...
        <h1
         ...
         text-black-primary font-inter w-[92%] md:w-10/12 lg:w-9/12">
          {t('hero_title_2')}
        </h1>
        <div className="flex justify-between">
          <h2 className="text-base md:text-2xl leading-6 md:leading-9 text-black-primary w-[92%] md:w-8/12 lg:w-6/12">
            {t('hero_desc_2')}
          </h2>
          <div className="relative w-[180px] lg:w-[310px] bottom-12 right-8 hidden md:block">
